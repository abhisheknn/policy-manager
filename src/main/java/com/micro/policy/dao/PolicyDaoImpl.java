...
public class PolicyDaoImpl implements PolicyDao {
	...
	public Policy createPolicy(Policy policy) {
		...
		createPolicyTable(policy, keySpace);
	...
	private void createPolicyTable(Policy policy, String keySpace) {
		Cassandra.createType(cassandraConnector.getSession(), keySpace, Constants.RULETYPE, Policy.getColumnsForRuleType());
		Cassandra.createTable(cassandraConnector.getSession(), keySpace,Constants.POLICYTABLE , Policy.getColoumnsForPolicyTable());
